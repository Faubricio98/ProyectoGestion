...
<style>
    ...
    <?php 
        if (count($vars['productos']) == 0) {
    ?>
            <section id="hero">
                <div class="hero-container" data-aos="fade-in">
                    <h1>Lo sentimos, no hay artículos para esta categoría</h1>
            ...
            <section id="get-started" class="padd-section text-center">
                <div class="container" data-aos="fade-up" style="margin-top: 2em;">
                    <div class="section-title text-center">
                        <h2>Estos son los artículos</h2>
                    </div>
                </div>
                <div class="container">
                    <div class="row">
                        <?php
                            foreach ($vars['productos'] as $item) {
                        ?>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            ...
            ?>
                        <li class="page-item">
                            <a class="page-link" href="?controlador=Categorias&accion=mostrar&id=<?php echo $vars['catId'] ?>&page=<?php echo $vars['previousPage'] ?>">Anterior</a>
                        </li>
            <?php
                    }
            ?>
            ...
            ?>
                        <li class="page-item">
                            <a class="page-link" href="?controlador=Productos&accion=mostrar&id=<?php echo $vars['catId'] ?>&page=<?php echo $vars['nextPage'] ?>">Siguiente</a>
                        </li>
            <?php
                    }
                }
